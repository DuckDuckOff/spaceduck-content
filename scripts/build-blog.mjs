...
function layout(title, content) {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escapeHtml(title)} · spaceduck</title><meta name="description" content="Field notes from the spaceduck signal."><link rel="stylesheet" href="/styles.css"></head><body><div class="shell"><header><a class="mark" href="https://spaceduck.ing"><span>✦</span> spaceduck.ing</a><nav><a href="/">journal</a><a href="/about/">about</a><a href="/synapses/">synapses</a><a href="https://synapses.weihr.org">WEIHR SynapSes</a><a href="/chat/">chat</a><a href="https://art.pops.mobi">POP-Art</a><a href="https://join.pops.mobi">POPchain</a><a href="/rss.xml">rss</a></nav></header>${content}<footer>posts total: ${posts.length} · signal received · spaceduck.ing</footer></div></body></html>`;
}
